...
****IMPORTANTE**** PARA RODAR O TESTE PARE A EXECUÇÃO DO PROJETO E NO TERMINAL EXECUTE "dotnet test" 
...
```
cd existing_repo
git remote add origin https://gitlab.com/leads550029/backendleads.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/leads550029/backendleads/-/settings/integrations)
